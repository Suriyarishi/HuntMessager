  ...
  return (
    <div className="flex flex-col h-full bg-[var(--bg-pastel)] overflow-hidden">
      <header className="p-6 pb-2 flex items-center gap-4 sticky top-0 bg-[var(--bg-pastel)]/80 backdrop-blur-xl z-20">
        ...
        <h1 className="text-xl font-black text-[var(--text-primary)]">Biometrics</h1>
      </header>
      ...
      <div className="p-8 flex-1 flex flex-col items-center justify-center overflow-y-auto hide-scrollbar">
        <div className="relative mb-12 flex flex-col items-center w-full max-w-sm">
          <div className={`w-48 h-48 rounded-[64px] transition-all duration-500 flex items-center justify-center border-4 border-[var(--surface-white)] shadow-xl ${isComplete ? 'bg-[#F0FFF4] shadow-[#2FED9A]/20' : 'neumorphic-elevated'
            }`}>
            {isComplete ? (
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                <svg className="w-16 h-16 text-[var(--text-primary)] opacity-20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="w-20 h-20 icon-container bg-[var(--bg-pastel)]">
          ...
          <div className="mt-10 text-center px-4">
            ...
            <p className="text-sm text-[var(--text-secondary)] mt-3 font-bold leading-relaxed uppercase tracking-widest opacity-70">
        ...
        {isComplete && (
          <div className="w-full space-y-4 animate-[fadeIn_0.5s_ease-out]">
            <p className="text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-[0.2em] px-4 mb-2">Configuration</p>

            <div className="p-4 neumorphic-elevated flex items-center justify-between">
              <span className="text-sm font-extrabold text-[var(--text-primary)] px-2">Unlock on app launch</span>
              <button
            ...
            <div className="p-4 neumorphic-elevated flex items-center justify-between">
              <span className="text-sm font-extrabold text-[var(--text-primary)] px-2">Require for Payments</span>
              <button
