  ...
  return (
    <div className="flex flex-col h-full bg-[#F4F7FA] overflow-hidden">
      <header className="p-6 pb-2 flex items-center gap-4 sticky top-0 bg-[#F4F7FA]/80 backdrop-blur-xl z-20">
        ...
        <h1 className="text-xl font-black text-[#1F2937]">Notifications</h1>
      </header>

      <div className="p-6 flex-1 overflow-y-auto hide-scrollbar pb-20">
        <section className="mb-10">
          <p className="text-[10px] font-black text-[#6B7280] uppercase tracking-[0.2em] px-4 mb-5">Message Notifications</p>
          <ToggleOption
        ...
        <section className="mb-10">
          <p className="text-[10px] font-black text-[#6B7280] uppercase tracking-[0.2em] px-4 mb-5">Group Notifications</p>
          <ToggleOption
            label="Group Tones"
        ...
        <section className="mb-10">
          <p className="text-[10px] font-black text-[#6B7280] uppercase tracking-[0.2em] px-4 mb-5">Calls</p>
        ...
        <section className="mb-12">
          <button className="w-full p-4 neumorphic-elevated active:scale-[0.98] transition-all text-[10px] font-black uppercase tracking-[0.2em] text-[#6B7280]">
        ...
        <div className="p-6 neumorphic-elevated !bg-[#F4FFF9] border-2 border-white mb-10">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-black text-sm text-[#1F2937]">Smart Alerts</h3>
              <p className="text-[10px] text-[#6B7280] font-bold leading-relaxed mt-2 italic">Hunt uses AI to silence noisy groups while ensuring you never miss important direct mentions.</p>
            </div>
          </div>
        </div>
      </div>
