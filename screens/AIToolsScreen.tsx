    ...
    <div className="flex flex-col h-full bg-[var(--bg-pastel)] overflow-hidden">
      <header className="p-6 pb-2 flex items-center justify-between sticky top-0 bg-[var(--bg-pastel)]/80 backdrop-blur-xl z-20">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-black text-[var(--text-primary)]">Creative AI</h1>
        </div>
          ...
          {(["1K", "2K", "4K"] as const).map(s => (
            <button
              ...
              className={`px-3 py-1.5 text-[10px] font-black rounded-lg transition-all ${size === s
                ...
                : 'neumorphic-inset text-[var(--text-secondary)]'
                }`}
            >
              {s}
            </button>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8 hide-scrollbar">
        <div className="aspect-square w-full rounded-[40px] neumorphic-elevated overflow-hidden relative border-4 border-[var(--surface-white)] transition-all shadow-xl">
          {isLoading ? (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-[var(--bg-pastel)]/50 backdrop-blur-md">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center opacity-30 mt-4">
              ...
              <p className="text-sm font-black uppercase tracking-[0.2em] text-[var(--text-primary)]">Describe your vision</p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-6 pb-4">
          <div className="space-y-3">
            <p className="text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-[0.2em] px-4">Prompt</p>
            <div className="input-field-neumorphic !p-5 transition-all">
              <textarea
                ...
                className="w-full bg-transparent outline-none text-sm font-medium leading-relaxed resize-none text-[var(--text-primary)] placeholder-[var(--text-secondary)]"
              />
            </div>
          </div>
      ...
      <div className="p-6 pb-10 bg-[var(--bg-pastel)] border-t border-[var(--surface-white)]/50">
        <p className="text-[10px] text-[var(--text-secondary)] font-black uppercase tracking-[0.2em] mb-4 px-1">Try asking for:</p>
